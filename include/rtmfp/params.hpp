...
const size_t MAX_DATA_PACKET_BURST     = 16; // §3.5.2.3 says 6, but that's too small
const Time   DATA_PACKET_BURST_PERIOD  = 0.001;
const Time   BURST_RTT_THRESH          = 0.0045;
const size_t MAX_EARLY_PACKETS         = MAX_DATA_PACKET_BURST + 2;
