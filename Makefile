...
SAMPLES = src/AMF.o src/FlashCryptoAdapter.o src/FlowSyncManager.o src/Media.o src/Performer.o src/PerformerPosixPlatformAdapter.o \
	src/PlainCryptoAdapter.o src/PosixPlatformAdapter.o src/RedirectorClient.o src/ReorderBuffer.o src/RunLoop.o \
	src/SelectRunLoop.o src/TCMessage.o
