...
SAMPLES = src/FlashCryptoAdapter.o src/Performer.o src/PerformerPosixPlatformAdapter.o \
	src/PlainCryptoAdapter.o src/PosixPlatformAdapter.o src/RunLoop.o src/SelectRunLoop.o
